    ...
    <div class="track_info_box" v-if="currentTrack">
      <div class="just_wrapper">
        ...
        <div class="track_sub_info">
          ...
          <div class="seekbar_box">
            <span class="track_duration">{{ formatDuration(currentTime) }}</span>
            <input
              class="player_range"
              type="range"
              v-model="currentTime"
              ...
              @change="stopDragging" />
            <span class="track_duration">{{ formatDuration(duration) }}</span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  setup() {
    ...
    const formatDuration = (duration_ms) => {
      const minutes = Math.floor(duration_ms / 60);
      const seconds = Math.floor(duration_ms % 60);
